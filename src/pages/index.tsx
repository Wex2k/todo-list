...
export default function Home({ content, id, complete }: ITodo) {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen w-full flex-col bg-gradient-to-b from-[#2e026d] to-[#15162c] font-sans">
        <h1 className="mb-7 flex justify-center text-5xl font-extrabold uppercase tracking-tight text-white sm:text-[5rem]">
          Todos
        </h1>
        <form
